...
# python benchmark/infer_cache.py -c static -b 0.8 -p 0.1 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c count -b 0.8 -p 0.1 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c cpp -b 0.8 -p 0.1 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c lfu -b 0.8 -p 0.1 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c freq-sync -b 0.8 -p 0.1 -t 10 -o testing --use_pinned_mem

# python benchmark/infer_cache.py -c static -p 0.1 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c count -p 0.1 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c cpp -p 0.1 -t 10 -o testing --use_pinned_mem

# python benchmark/infer_cache.py -c static -b 0.8 -p 0.2 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c count -b 0.8 -p 0.2 -t 10 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c cpp -b 0.8 -p 0.2 -t 10 -o testing --use_pinned_mem

# python benchmark/infer_cache.py -c static -p 0.2 -t 10 -o testing --use_pinned_mem
...
# python benchmark/infer_cache.py -c freq-sync -b 0.8 -p 0.2 -t 3 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c freq-sync -p 0.2 -t 3 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c freq-sync -b 0.8 -p 0.1 -t 3 -o testing --use_pinned_mem
# python benchmark/infer_cache.py -c freq-sync -b 0.8 -p 0.1 -t 3 -o testing --use_pinned_mem
